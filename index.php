...
<head>
	<meta charset="utf-8" />
	<title>Casa De Oracion El Redil</title>
...
?>
		...
		<div class="form-vertical login-form">
			<p><h3 class="form-title">Login</h3></p>
			<div class="alert alert-error hide">
				<button class="close" data-dismiss="alert"></button>
				<span>Campos en blanco!!.</span>
			</div>
...
?>
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
		2016 &copy; Casa De Oracion El Redil
	</div>
	<!-- END COPYRIGHT -->
	...
	<script>
		...
		function login(){
			...
			var two = $("#password").val();
			      $.post("php/verificar.php",{var1:one,var2:two},function(respuesta){
			      		if (respuesta>0) {
			      			$("#content").load("php/menu.php");
			      		} else{
